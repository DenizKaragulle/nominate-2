...
description: JS Styleguide for Tailcoat
search_description: Below is an effort to standardize the syntax used when writing all Javascript. The hope is to make these decisions easy, and keep codebases clean and sensible.
section: Guide
layout: guide
---
...
According to [scientific research][hnsemicolons], the usage of semicolons is a core values of our community. Consider the points of [the opposition][], but be a traditionalist when it comes to abusing error correction mechanisms for
cheap syntactic pleasures.

[the opposition]: http://blog.izs.me/post/2353458699/an-open-letter-to-javascript-leaders-regarding [hnsemicolons]: http://news.ycombinator.com/item?id=1547647
