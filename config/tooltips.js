...
define({
	...
	"ITEM_THUMBNAIL_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"ITEM_SUMMARY_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"ITEM_DESCRIPTION_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"ACCESS_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"PERFORMANCE_MAP_LAYERS_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
			...
			'<p>The score: Points are awarded for having more than three tags total. Points are awarded for choosing only one tag from the list at left, to indicate the primary category for your item. Points deducted for tags “copy”, “demo”, “test”, “eval”.</p>' +
			'</div>',
	"PERFORMANCE_SHARING_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
			...
			'</div>',
	"PERFORMANCE_DRAW_TIME_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
			'<p>The idea: Maps that draw quickly are desirable.</p>' +
			'<p>The score: the faster the map is, the higher the score.</p>' +
			'</div>',
	"PERFORMANCE_POP_UPS_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"USER_PROFILE_FULL_NAME_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
	...
	"USER_PROFILE_DESCRIPTION_TOOLTIP_CONTENT":'<div class="custom-tooltip-style">' +
